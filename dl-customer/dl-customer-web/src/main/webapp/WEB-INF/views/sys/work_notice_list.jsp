...
<body >
		<table class="easyui-datagrid" id="dg" title="系统管理-公告管理" style="width:100%;height:485px;"  ></table>
...
<!-- 				<a href="#" class="easyui-linkbutton" iconCls="icon-cut" plain="true"></a> -->
			...
			<div class="easyui-panel" style="padding:5px;">
						公告标题:<input id="title"  class="easyui-input" style="width:120px;">
	...
	<script type="text/javascript">
		$(function(){
			$('#dg').datagrid({
				  ...
				  fitColumns:true,
				  method:"post",
				  url:'${path }/sys/noticeController/listData',
				  method:'post' ,
				    columns:[[    
				        {field:'title',title:'公告标题',width:100},    
				        {field:'contents',title:'公告内容',width:100},    
		...
		*/
		function del(id){
			$.messager.confirm('确认','您确认想要删除记录吗？',function(r){    
				if(r){
					$.post('${path }/sys/noticeController/del',{id:id},function (data){
						if(data=="success"){
		...
		*/
		function update(id){
			var url = "${path }/sys/noticeController/input?id="+id;
			location.href=url;
		}
		/**
		* 新增方法
		*/
		function add(){
			var url = "${path }/sys/noticeController/input?id=";
			location.href=url;
		}
		/**
		* 查看方法
		*/
		function view(id){
			var url = "${path }/sys/noticeController/view?id="+id;
			location.href=url;
		}
	</script>
</body>
